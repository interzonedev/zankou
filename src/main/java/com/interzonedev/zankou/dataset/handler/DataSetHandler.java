...
public interface DataSetHandler {
     ...
     * if it is set.
     * 
     * @param dataSetFile The file that contains the data with which to set up the database.
     * @param dataSourceInstance A datasource that is connected to the database being tested.
     * @param dataSetTransformer An instance of {@link DataSetTransformer} that can alter each record parsed from the
     *            dataset file.
     */
     ...
     * source.
     * 
     * @param dataSetFile The file that contains the data to clean from the database.
     * @param dataSourceInstance A datasource that is connected to the database being tested.
     */
