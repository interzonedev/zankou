...
public class MongoUtils {
     ...
     * 
     * @param fileContents The contents to parse into the {@code DBObject} instance.
     * 
     ...
     * 
     * @param fileContents The contents from which to get the collection names.
     * 
     ...
     * 
     * @param dataSetFilename The name of the dataset file to parse.
     * @param collectionName The name of the collection to parse from the dataset file.
     * @param ignorePropertyNames The list of properties to remove from the collection.
     * 
     ...
     * 
     * @param mongoTemplate The {@code MongoTemplate} that has a connection to the MongoDB database.
     ...
     * 
     * @param dbObj The {@code DBObject} instance from which to remove the properties.
     * @param ignorePropertyNames The list of property names to remove.
     */
