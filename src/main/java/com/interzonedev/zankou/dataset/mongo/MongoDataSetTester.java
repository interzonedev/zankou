...
public class MongoDataSetTester {
     ...
     * @param expectedDataSetFilename The file name of the dataset file that contains the expected values.
     * @param collectionName The name of the collection to compare.
     * @param ignorePropertyNames The list of properties to ignore in the specified collection.
     */
